<!DOCTYPE html>
    ...
    <body class="m-5">
        <?php
        if (isset($_GET["usuario"]) && !empty($_GET["usuario"]) && isset($_GET["tamanio"]) && !empty($_GET["tamanio"]) && isset($_GET["base"]) && !empty($_GET["base"]) && isset($_GET["salsa"]) && !empty($_GET["salsa"]) && isset($_GET["ingredientes"]) && !empty($_GET["ingredientes"])) {
            ...
            fwrite($fichero, date("d-m-Y H:i:s") . ";$usuario;$tamanio;$base;$salsa;(" . implode(",", $ingredientes) . ");$resultado\n");
            fclose($fichero);
        ...
        <form method="get">
            <div class="row">
                <div class="col"><label for="usuario">Usuario</label></div>
                <div class="col"><input type="text" name="usuario" id="usuario" placeholder="Introduce tu nombre" /></div>
            </div>
            <div class="row">
